### Script for visualizing training sessions.
### @author : Guozheng Xu
### @date   : 2024-07-06
############################################################################
import torch
...
#%% Plot training process with rewards
exp_per_ep = 15
warm_up = 4000
...
#%% Plot training process with RMS wavefront error
...
plt.ylim([0,0.4])
plt.legend()
plt.savefig(file_path+'RMSWFE_plot.pdf',dpi = 100)
#%% Plot both
...
ax[0].legend()
ax[1].legend()
plt.savefig(file_path+'combined_training_vis.pdf',dpi = 100)
